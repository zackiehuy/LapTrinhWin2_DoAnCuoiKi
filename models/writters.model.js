...
module.exports = {
    listaccept : function(id){
        return db.load(`SELECT tittle,abstract as ab,content,name,n.idmaincategory FROM newspaper as n join maincategory as mc on 
    n.idmaincategory = mc.idmaincategory WHERE n.writter = ${id} and (n.status = 1 or n.status = 2)`);
    },
    listrefuse : function(id){
        return db.load(`SELECT idnews,tittle,abstract as ab,content,name,reason,n.idmaincategory FROM newspaper as n join maincategory as mc on 
    ...
    single : function(id){
        ...
        n.idmaincategory = mc.idmaincategory WHERE n.idnews = ${id} and (n.status = 4 or n.status = 3)`);
    },
